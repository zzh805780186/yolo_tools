...
def extract_image_label(root_path, extract_num = 50):
    ...
    save_path = os.path.join(root_path, 'extract_data')
...
if __name__ == '__main__':
    ...
    extract_image_label(r'F:\ZZH\DATA\count', 50)